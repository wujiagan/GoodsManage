...
<body class="home">
<%
	List<Order> all = DAOFactory.getOrderOutDAOInstance().findAll(new SimpleDateFormat("yyyy-MM-dd").parse(request.getParameter("start_date")), new SimpleDateFormat("yyyy-MM-dd").parse(request.getParameter("end_date")));
